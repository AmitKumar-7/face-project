...
classifier = cv2.CascadeClassifier(r"C:/Users/KIIT/Desktop/Amit Kumar(Face project)/haarcascade_frontalface_default (1).xml")
model = load_model(r"C:/Users/KIIT/Desktop/Amit Kumar(Face project)/fac.h5")

URL =  "http://192.168.198.34:8080/shot.jpg"
